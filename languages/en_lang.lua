Locales["en_lang"] = {
    ...
    -- Previously hardcoded UI text
    admin_no_banks_found = "No banks found.",
    admin_create_bank_here = "Create Bank At Your Location",
    admin_create_bank_header = "Create Bank",
    ...
    menu_prompt = "Menu",
    lockpick_need_item = "You need a lockpick.",
    lockpick_resource_missing = "Lockpick resource \"%s\" is not started.",
    lockpick_success = "Lockpick succeeded.",
    lockpick_failed = "Lockpick failed.",
    lockpick_door_prompt = "Lockpick Door",
    error_not_at_bank = "You must be at the bank to use this service.",
